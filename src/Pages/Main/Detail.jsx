...
function Detail() {
  ...
  const { isLoading2, error2, comments } = useSelector(
    ...
    <div>
      ...
      >
        <FontAwesomeIcon
          ...
          type="button"
          size="lg"
          style={{ float: 'right', margin: '5px 21px 0 0', color: 'white' }}
          onClick={() => {
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'row' }}>
          ...
          <Flex2>
            <div style={{ display: 'flex', margin: '10px 10px 16px 10px' }}>
              <span style={{ width: '40%' }}>Product Info</span>{' '}
              <span style={{ fontSize: 'small', color: '#b2b2b2' }}>
                제품정보
              </span>
            </div>
            <div style={{ display: 'flex', margin: '10px' }}>
              <Title>Title</Title> <Desc>{product.title}</Desc>
            </div>
            <div style={{ display: 'flex', margin: '10px' }}>
            ...
            >
              <Title>Desc</Title> <Desc>{product.content}</Desc>
            </div>
          </Flex2>
        </div>
